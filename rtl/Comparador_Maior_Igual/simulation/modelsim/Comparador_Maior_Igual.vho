...
ENTITY 	Comparador_Maior_Igual IS
	...
	sinal_maior_igual : BUFFER std_logic
	);
END Comparador_Maior_Igual;

-- Design Ports Information
-- sinal_maior_igual	=>  Location: PIN_C6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- total_inserido[7]	=>  Location: PIN_D9,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- preco_produto[7]	=>  Location: PIN_E9,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- total_inserido[6]	=>  Location: PIN_D8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- preco_produto[6]	=>  Location: PIN_C7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- total_inserido[5]	=>  Location: PIN_B5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- preco_produto[5]	=>  Location: PIN_A2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- total_inserido[4]	=>  Location: PIN_A5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- preco_produto[4]	=>  Location: PIN_H11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- total_inserido[3]	=>  Location: PIN_D7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- preco_produto[3]	=>  Location: PIN_A6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- total_inserido[2]	=>  Location: PIN_B7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- preco_produto[2]	=>  Location: PIN_J10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- total_inserido[1]	=>  Location: PIN_A3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- preco_produto[1]	=>  Location: PIN_A4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- total_inserido[0]	=>  Location: PIN_B4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- preco_produto[0]	=>  Location: PIN_D10,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF Comparador_Maior_Igual IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
SIGNAL ww_sinal_maior_igual : std_logic;
...
SIGNAL \sinal_maior_igual~output_o\ : std_logic;
...
sinal_maior_igual <= ww_sinal_maior_igual;
ww_devoe <= devoe;
ww_devclrn <= devclrn;
ww_devpor <= devpor;
...
\sinal_maior_igual~output\ : fiftyfivenm_io_obuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
...
-- Equation(s):
-- \LessThan0~1_cout\ = CARRY((!\total_inserido[0]~input_o\ & \preco_produto[0]~input_o\))
...
-- pragma translate_on
PORT MAP (
	dataa => \total_inserido[0]~input_o\,
	datab => \preco_produto[0]~input_o\,
	datad => VCC,
...
-- Equation(s):
-- \LessThan0~3_cout\ = CARRY((\preco_produto[1]~input_o\ & (\total_inserido[1]~input_o\ & !\LessThan0~1_cout\)) # (!\preco_produto[1]~input_o\ & ((\total_inserido[1]~input_o\) # (!\LessThan0~1_cout\))))
...
-- Equation(s):
-- \LessThan0~5_cout\ = CARRY((\preco_produto[2]~input_o\ & ((!\LessThan0~3_cout\) # (!\total_inserido[2]~input_o\))) # (!\preco_produto[2]~input_o\ & (!\total_inserido[2]~input_o\ & !\LessThan0~3_cout\)))
...
-- Equation(s):
-- \LessThan0~7_cout\ = CARRY((\total_inserido[3]~input_o\ & ((!\LessThan0~5_cout\) # (!\preco_produto[3]~input_o\))) # (!\total_inserido[3]~input_o\ & (!\preco_produto[3]~input_o\ & !\LessThan0~5_cout\)))
...
-- Equation(s):
-- \LessThan0~9_cout\ = CARRY((\total_inserido[4]~input_o\ & (\preco_produto[4]~input_o\ & !\LessThan0~7_cout\)) # (!\total_inserido[4]~input_o\ & ((\preco_produto[4]~input_o\) # (!\LessThan0~7_cout\))))
...
-- Equation(s):
-- \LessThan0~11_cout\ = CARRY((\total_inserido[5]~input_o\ & ((!\LessThan0~9_cout\) # (!\preco_produto[5]~input_o\))) # (!\total_inserido[5]~input_o\ & (!\preco_produto[5]~input_o\ & !\LessThan0~9_cout\)))
...
-- Equation(s):
-- \LessThan0~13_cout\ = CARRY((\total_inserido[6]~input_o\ & (\preco_produto[6]~input_o\ & !\LessThan0~11_cout\)) # (!\total_inserido[6]~input_o\ & ((\preco_produto[6]~input_o\) # (!\LessThan0~11_cout\))))
...
-- Equation(s):
-- \LessThan0~14_combout\ = (\preco_produto[7]~input_o\ & ((\LessThan0~13_cout\) # (!\total_inserido[7]~input_o\))) # (!\preco_produto[7]~input_o\ & (\LessThan0~13_cout\ & !\total_inserido[7]~input_o\))
...
ww_sinal_maior_igual <= \sinal_maior_igual~output_o\;
END structure;
